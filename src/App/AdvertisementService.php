...
class AdvertisementService
{
    ...
    public function createAdvertisement(array $args = []): array
    {
        ...
        if ($this->advertisementMapper->isAdvertisementIdExist($postId) === true) {
            return self::respondWithError('AdvertisementId already exist.');
        }
        ...
        try {
            ...
            $this->logger->info('Create Post advertisementData', ['advertisementData' => $advertisementData]);
    ...
    public function convertEuroToTokens(float $amount = 0): array
    {
        ...
        try {
            ...
            return $this->respondWithError('error on catch');
        }
    }
