...
class PeerTokenService
{
    ...
    public function transferToken(array $args): array
    {
        ...
        if (false === $this->interactionsPermissionsMapper->isInteractionAllowed($specs, $recipientid)) {
        ...
        try {
            ...
            $isStrictDecimal = '' !== $numRaw && 1 === preg_match('/^(?:\d+)(?:\.\d+)?$/', $numRaw);
