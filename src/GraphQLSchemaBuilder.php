...
class GraphQLSchemaBuilder
{
    ...
    protected function buildMutationResolvers(): array
    {
        return [
            ...
            'advertisePostBasic' => fn (mixed $root, array $args) => $this->postService->resolveAdvertisePost($args),
            'advertisePostPinned' => fn (mixed $root, array $args) => $this->postService->resolveAdvertisePost($args),
        ];
    }
    ...
    // moved to PostService: advertisePostBasicResolver, advertisePostPinnedResolver

    // Werbeanzeige prüfen, validieren und freigeben
    // moved to PostService::resolveAdvertisePost
