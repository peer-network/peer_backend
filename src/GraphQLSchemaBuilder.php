...
class GraphQLSchemaBuilder
{
    ...
    protected function buildQueryResolvers(): array
    {
        ...
        return [
            ...
            'gemster' => fn (mixed $root, array $args) => $this->mintService->callGemster(),
    ...
    protected function buildMutationResolvers(): array
    {
        return [
            ...
            'globalwins' => fn (mixed $root, array $args) => $this->mintService->callGlobalWins(),
            'gemsters' => fn (mixed $root, array $args) => $this->mintService->callGemsters($args['day']),
