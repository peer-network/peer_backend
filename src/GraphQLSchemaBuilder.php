...
class GraphQLSchemaBuilder
{
    ...
    public function buildResolvers(): array
    {
        return [
            ...
            'Profile' => [
                'id' => function (array $root): string {
                    $this->logger->info('Query.Profile Resolvers');
                    return $root['uid'] ?? '';
                },
                'situation' => function (array $root): string {
                    $status = $root['status'] ?? 0;
            ...
            'CommentInfo' => [
                'userid' => function (array $root): string {
                    $this->logger->info('Query.CommentInfo Resolvers');
                    return $root['userid'] ?? '';
                },
                'likes' => function (array $root): int {
                    return $root['likes'] ?? 0;
            ...
            'ListTodaysInteractionsResponse' => [
                'status' => function (array $root): string {
                    $this->logger->info('Query.ListTodaysInteractionsResponse Resolvers');
                    return $root['status'] ?? '';
                },
                'ResponseCode' => function (array $root): string {
                    return $root['ResponseCode'] ?? '';
            ...
            'PercentBeforeTransactionData' => [
                'inviterId' => function (array $root): string {
                    $this->logger->info('Query.PercentBeforeTransactionData Resolvers');
            ...
            'ContactusResponse' => [
                'status' => function (array $root): string {
                    $this->logger->info('Query.ContactusResponse Resolvers');
                    return $root['status'] ?? '';
                },
                'ResponseCode' => function (array $root): string {
                    return $root['ResponseCode'] ?? '';
            ...
            'GemstersResponse' => [
                'status' => function (array $root): string {
                    $this->logger->info('Query.GemstersResponse Resolvers');
                    return $root['status'] ?? '';
                },
                'counter' => function (array $root): int {
                    return $root['counter'] ?? 0;
            ...
            'TestingPoolResponse' => [
                'status' => function (array $root): string {
                    $this->logger->info('Query.TestingPoolResponse Resolvers');
                    return $root['status'] ?? '';
                },
                'counter' => function (array $root): int {
                    return $root['counter'] ?? 0;
            ...
            'LogWins' => [
                'from' => function (array $root): string {
                    $this->logger->info('Query.LogWins Resolvers');
                    return $root['from'] ?? '';
                },
            ...
            'ReferralUsers' => [
                'invitedBy' => function (array $root): ?array {
                    $this->logger->info('Query.ReferralUsers Resolvers');
            ...
            'ActionPriceResult' => [
                'postPrice' => function (array $root): float {
                    $this->logger->info('Query.ActionPriceResult Resolvers');
            ...
            'Transaction' => [
                'transactionid' => function (array $root): string {
                    $this->logger->info('Query.Transaction Resolvers');
    ...
    protected function resolveActionPrices(): ?array
    {
        ...
        $this->logger->info('PoolService.resolveActionPrices started');
     ...
     * 
     */
    protected function transactionsHistory(array $args): array
    {
